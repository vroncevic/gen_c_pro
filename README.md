...
```bash
tar xvzf gen_c_pro-3.0.tar.gz
cd gen_c_pro-3.0
cp -R ~/sh_tool/bin/   /root/scripts/gen_c_pro/ver.3.0/
cp -R ~/sh_tool/conf/  /root/scripts/gen_c_pro/ver.3.0/
cp -R ~/sh_tool/log/   /root/scripts/gen_c_pro/ver.3.0/
```
...
/root/scripts/gen_c_pro/ver.3.0/
├── bin/
│   └── gen_c_pro.sh
├── conf/
│   ├── gen_c_pro.cfg
...
lrwxrwxrwx 1 root root 48 Dec  4 06:15 /root/bin/gen_c_pro -> /root/scripts/gen_c_pro/ver.3.0/bin/gen_c_pro.sh
```
...
ln -s /root/scripts/gen_c_pro/ver.3.0/bin/gen_c_pro.sh /root/bin/gen_c_pro
...
[check_root] Done
  ...
  ░░██████░██░░░░  ░██  ░██      ░██   ██      ░██░░░   ░██   ░██   ░██  
   ...
   ░░░░░                                                                 
		...
		Info   github.io/gen_c_pro ver.3.0 
...
[check_cfg] Checking configuration file [/root/scripts/gen_c_pro/ver.3.0/conf/gen_c_pro.cfg] [ok]
[check_cfg] Done

[load_conf] Done

[load_util_conf] Load module configuration!
[check_cfg] Checking configuration file [/root/scripts/gen_c_pro/ver.3.0/conf/gen_c_pro_util.cfg] [ok]
[check_cfg] Done

[load_util_conf] Done

[load_util_conf] Load module configuration!
[check_cfg] Checking configuration file [/root/scripts/gen_c_pro/ver.3.0/conf/project_set.cfg] [ok]
[check_cfg] Done
...
[gen_c_pro] Set permission!
[logging] Checking directory [/root/scripts/gen_c_pro/ver.3.0/log/]? [ok]

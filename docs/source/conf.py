...
Copyright
    ...
    gen_c_pro is distributed in the hope that it will be useful, but
...
htmlhelp_basename: str = 'gen_c_prodoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_c_pro.tex', 'gen_c_pro Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_c_pro', 'gen_c_pro Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_c_pro', 'gen_c_pro Documentation', author, 'gen_c_pro',
